...
def load_settings(config_path: Optional[str] = None) -> Settings:
    ...
    s = Settings(
        ...
        run_max_tokens=int(raw.get("run_max_tokens", 200_000)),
        run_max_cost=float(raw.get("run_max_cost", 1.0)),
        loop_detect_count=int(raw.get("loop_detect_count", 5)),
        run_max_duration=int(raw.get("run_max_duration", 600)),
        sse_heartbeat_interval=float(raw.get("sse_heartbeat_interval", 5.0)),
...
def save_settings() -> None:
    ...
    data = {
        ...
        "run_max_tokens": s.run_max_tokens,
        "run_max_cost": s.run_max_cost,
        "loop_detect_count": s.loop_detect_count,
        "run_max_duration": s.run_max_duration,
        "sse_heartbeat_interval": s.sse_heartbeat_interval,
